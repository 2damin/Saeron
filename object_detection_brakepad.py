...
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, '{}.jpg'.format(i)) for i in range(int(start), int(end)) ]
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    for image_path in TEST_IMAGE_PATHS:
      ...
      cvimage = cv2.cvtColor(image1,cv2.COLOR_RGB2BGR)
      ...
      image_np_ex1 = np.reshape(cvimage, (1,height,width,3))
